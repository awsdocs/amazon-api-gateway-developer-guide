...
1. Validate claims\. API Gateway evaluates the following token claims:
   ...
   + [https://tools.ietf.org/html/rfc7519#section-4.1.4](https://tools.ietf.org/html/rfc7519#section-4.1.4) – Must be before the current time in UTC\. 
   + [https://tools.ietf.org/html/rfc7519#section-4.1.5](https://tools.ietf.org/html/rfc7519#section-4.1.5) – Must be after the current time in UTC\. 
