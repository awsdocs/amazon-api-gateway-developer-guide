...
+ [Publish Your API Gateway APIs](apigateway-publish-your-apis.md)
...
+ [Getting Started with REST APIs in Amazon API Gateway](getting-started.md)
...
+ [Amazon API Gateway Limits and Known Issues](limits.md)
